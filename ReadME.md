...
A modern, fully responsive sushi restaurant landing page built with **HTML**, **CSS**, and **Vite**. The project focuses on clean UI design, reusable components, smooth animations, and scalable CSS architecture while delivering an elegant user experience across all screen sizes.

## 🌐 Live Demo

**Website:** https://anteiku-sushi.netlify.app/

## 📂 Repository

**GitHub:** https://github.com/adarshdas13/sushi-theme
...
| JavaScript (ES6+) | Dynamic rendering and interactions |
